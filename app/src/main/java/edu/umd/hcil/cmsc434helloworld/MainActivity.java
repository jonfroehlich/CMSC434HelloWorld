package edu.umd.hcil.cmsc434helloworld;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // This is just another SeekBar example that I created in class to further reinforce
        // how to use listeners. Remember, allow Android Studio to help you by using alt-enter
        // and clicking on the red lightbulb as you right code (which will auto-generate code for you)
     ...
     * actually wants to reset the background color. This method is hooked up in activity_main.xml
     * @param v
     */
